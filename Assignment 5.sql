...
insert into bank.Customer(CName,CEmail,Contact) values ('Charan','Charan@gmail.com',9876543210)
insert into bank.Customer(CName,CEmail,Contact) values ('Sri','sri@gmail.com',9876545216)
insert into bank.Customer(CName,CEmail,Contact) values ('Sam','sam@gmail.com',8765431166)
